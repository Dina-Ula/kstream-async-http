...
@XmlRootElement(name = "E535AccountPostingRequest", namespace = "urn:demo:rcbs:e535")
...
public class E535AccountPostingRequest {
    ...
    public E535AccountPostingRequest() {}

    public E535AccountPostingRequest(String requestId, BigDecimal amount, String tenantId) {
