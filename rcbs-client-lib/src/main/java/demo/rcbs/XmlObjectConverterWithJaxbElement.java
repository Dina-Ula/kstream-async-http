...
public final class XmlObjectConverterWithJaxbElement<T> {
    private final Class<T> targetType;
    private final Marshaller marshaller;
    private final Unmarshaller unmarshaller;

    public XmlObjectConverterWithJaxbElement(Class<T> targetType, Marshaller marshaller, Unmarshaller unmarshaller) {
